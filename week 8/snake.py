...
def show_score(choice, color, font, size) :
    ...
    # создать объект поверхности отображения score_surface
    score_surface = score_font.render('Score : ' + str(score), True, color)

    # создаем прямоугольный объект для текста поверхностный объект
...
def game_over() :
    ...
    # создание текстовой поверхности, на которой текст будет нарисовано
    game_over_surface = my_font.render(
        'Your Score is : ' + str(score), True, red)

    # создать прямоугольный объект для текста surface object
...
while True :
    ...
    # Если две клавиши нажаты одновременно мы не хотим, чтобы змея разделялась на две направлений одновременно
    ...
    # Механизм роста тела змеи если фрукты и змеи сталкиваются, то очки будет увеличено на 10
